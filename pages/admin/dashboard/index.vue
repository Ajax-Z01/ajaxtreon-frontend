  ...
  <div class="p-8 bg-gray-100 min-h-screen">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
      ...
      <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        ...
        <router-link to="dashboard/user" class="text-blue-500 hover:text-blue-700">Go to User Dashboard</router-link>
      </div>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        ...
        <router-link to="dashboard/order" class="text-blue-500 hover:text-blue-700">Go to Order Dashboard</router-link>
      </div>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        ...
        <router-link to="dashboard/purchase" class="text-blue-500 hover:text-blue-700">Go to Purchase Dashboard</router-link>
      </div>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        ...
        <router-link to="dashboard/payment" class="text-blue-500 hover:text-blue-700">Go to Payment Dashboard</router-link>
      </div>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        ...
        <router-link to="dashboard/customer" class="text-blue-500 hover:text-blue-700">Go to Customer Dashboard</router-link>
      </div>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        ...
        <router-link to="dashboard/supplier" class="text-blue-500 hover:text-blue-700">Go to Supplier Dashboard</router-link>
      </div>
      
      <!-- Report Management Card -->
      <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        <h2 class="text-xl font-semibold mb-4">Report Management</h2>
        <p class="text-gray-500 mb-4">Generate and view reports.</p>
        <router-link to="dashboard/report" class="text-blue-500 hover:text-blue-700">Go to Report Dashboard</router-link>
      </div>
    </div>
  </div>
</template>
